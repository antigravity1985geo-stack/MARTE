// pages/clinic/ConsentFormsPage.tsx
...
function TemplatePicker({
  ...
  const cats = Array.from(new Set(templates.map(t => t.category))) as ConsentCategory[];
...
export default function ConsentFormsPage({
  ...
  return (
    <div className={`${hideHeader ? 'p-0' : 'max-w-5xl mx-auto p-4'} space-y-5`}>
